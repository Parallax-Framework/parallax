ax.localization:Register("es", {
    ...
    ["tab.help"] = "Ayuda",
    ["tab.help.overview"] = "Resumen",
    ["tab.help.commands"] = "Comandos",
    ["tab.help.factions"] = "Facciones",
    ...
    ---- Respawn
    ["config.respawn.delay"] = "Tiempo de Reaparición",
    ["config.respawn.delay.help"] = "Tiempo en segundos antes de que un jugador pueda reaparecer tras morir.",
    ...
    ["option.performance.blur.help"] = "Desactiva los costosos desenfoques de fondo en elementos de interfaz de cristal.",
    ["option.performance.vignette.trace"] = "Habilitar Traza de Proximidad de Viñeta",
