ax.localization:Register("tr", {
    ...
    ["tab.help"] = "Yardım",
    ["tab.help.overview"] = "Genel Bakış",
    ["tab.help.commands"] = "Komutlar",
    ["tab.help.factions"] = "Fraksiyonlar",
    ...
    ["subcategory.appearance"] = "Görünüm",
    ["subcategory.animations"] = "Animasyonlar",
    ["subcategory.performance"] = "Performans",
    ["subcategory.behavior"] = "Davranış",
    ["subcategory.distances"] = "Mesafeler",
    ["subcategory.effects"] = "Efektler",
    ["subcategory.formatting"] = "Biçimlendirme",
    ["subcategory.fonts"] = "Yazı Tipleri",
    ["subcategory.hud"] = "HUD",
    ["subcategory.interaction"] = "Etkileşim",
    ["subcategory.inventory"] = "Envanter",
    ["subcategory.layout"] = "Yerleşim",
    ["subcategory.movement"] = "Hareket",
    ["subcategory.notifications"] = "Bildirimler",
    ["subcategory.position"] = "Pozisyon",
    ["subcategory.size"] = "Boyut",
    ["subcategory.typography"] = "Tipografi",
    ...
    ["option.performance.blur.help"] = "Cam arayüz öğelerindeki maliyetli arka plan bulanıklığını devre dışı bırakır.",
    ["option.performance.vignette.trace"] = "Vinyet Yakınlık İzini Etkinleştir",
    ...
    ["option.hud.elements.enabled"] = "HUD Öğelerini Etkinleştir",
    ["option.hud.targetid.enabled"] = "TargetID Etiketlerini Etkinleştir",
    ["option.hud.targetid.distance"] = "TargetID Mesafesi",
    ["option.hud.targetid.fade_speed_in"] = "TargetID Belirme Hızı",
    ["option.hud.targetid.fade_speed_out"] = "TargetID Kaybolma Hızı",
    ["option.hud.targetid.position_speed"] = "TargetID Takip Hızı",
    ["option.hud.targetid.max_width"] = "TargetID Açıklama Genişliği",
    ["option.hud.targetid.line_spacing"] = "TargetID Satır Aralığı",
    ["option.hud.targetid.visible_delay"] = "TargetID Görünürlük Gecikmesi",
    ["option.hud.targetid.player_offset"] = "TargetID Oyuncu Ofseti",
    ["option.hud.targetid.flash_speed"] = "TargetID Yanıp Sönme Hızı",
    ["option.hud.targetid.show_descriptions"] = "TargetID Açıklamalarını Göster",
    ["option.hud.targetid.show_extras"] = "TargetID Ek Satırlarını Göster",
    ["option.hud.elements.enabled.help"] = "Tüm framework HUD öğelerini etkinleştirir veya devre dışı bırakır.",
    ["option.hud.targetid.enabled.help"] = "Varlıklara bakarken TargetID etiketlerini etkinleştirir veya devre dışı bırakır.",
    ["option.hud.targetid.distance.help"] = "TargetID etiketlerinin varlıkları ne kadar uzaktan algılayabileceği.",
    ["option.hud.targetid.fade_speed_in.help"] = "TargetID etiketlerinin ne kadar hızlı belireceği.",
    ["option.hud.targetid.fade_speed_out.help"] = "TargetID etiketlerinin ne kadar hızlı kaybolacağı.",
    ["option.hud.targetid.position_speed.help"] = "TargetID etiketlerinin hareket eden varlıkları ne kadar hızlı takip edeceği.",
    ["option.hud.targetid.max_width.help"] = "Kaydırmadan önceki en yüksek TargetID açıklama genişliği.",
    ["option.hud.targetid.line_spacing.help"] = "TargetID açıklama satırları arasındaki dikey boşluk.",
    ["option.hud.targetid.visible_delay.help"] = "Doğrudan bakış kaybolduktan sonra TargetID etiketlerinin ne kadar süre görünür kalacağı.",
    ["option.hud.targetid.player_offset.help"] = "Oyuncular ve oyuncu ragdoll'ları için dikey TargetID etiketi ofseti.",
    ["option.hud.targetid.flash_speed.help"] = "Yanıp sönen TargetID etiketlerinin ne kadar hızlı titreşeceği.",
    ["option.hud.targetid.show_descriptions.help"] = "TargetID etiketlerinin altında varsayılan eşya ve karakter açıklamalarını gösterir.",
    ["option.hud.targetid.show_extras.help"] = "Varlıklar tarafından sağlanan ek TargetID açıklama satırlarını gösterir.",
