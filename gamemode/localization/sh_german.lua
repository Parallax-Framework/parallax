ax.localization:Register("de", {
    ...
    ["mainmenu.category.01_appearance"] = "Aussehen",
    ["mainmenu.category.02_identity"] = "Identität",
    ...
    ["option.hud.elements.enabled"] = "HUD-Elemente aktivieren",
    ["option.hud.targetid.enabled"] = "TargetID-Beschriftungen aktivieren",
    ["option.hud.targetid.distance"] = "TargetID-Distanz",
    ["option.hud.targetid.fade_speed_in"] = "TargetID-Einblendgeschwindigkeit",
    ["option.hud.targetid.fade_speed_out"] = "TargetID-Ausblendgeschwindigkeit",
    ["option.hud.targetid.position_speed"] = "TargetID-Folgegeschwindigkeit",
    ["option.hud.targetid.max_width"] = "TargetID-Beschreibungsbreite",
    ["option.hud.targetid.line_spacing"] = "TargetID-Zeilenabstand",
    ["option.hud.targetid.visible_delay"] = "TargetID-Sichtbarkeitsverzögerung",
    ["option.hud.targetid.player_offset"] = "TargetID-Spieler-Versatz",
    ["option.hud.targetid.flash_speed"] = "TargetID-Blinkgeschwindigkeit",
    ["option.hud.targetid.show_descriptions"] = "TargetID-Beschreibungen anzeigen",
    ["option.hud.targetid.show_extras"] = "TargetID-Zusatzzeilen anzeigen",
    ["option.hud.elements.enabled.help"] = "Aktiviert oder deaktiviert alle Framework-HUD-Elemente.",
    ["option.hud.targetid.enabled.help"] = "Aktiviert oder deaktiviert TargetID-Beschriftungen beim Ansehen von Entitäten.",
    ["option.hud.targetid.distance.help"] = "Wie weit TargetID-Beschriftungen Entitäten erkennen können.",
    ["option.hud.targetid.fade_speed_in.help"] = "Wie schnell TargetID-Beschriftungen einblenden.",
    ["option.hud.targetid.fade_speed_out.help"] = "Wie schnell TargetID-Beschriftungen ausblenden.",
    ["option.hud.targetid.position_speed.help"] = "Wie schnell TargetID-Beschriftungen bewegten Entitäten folgen.",
    ["option.hud.targetid.max_width.help"] = "Maximale Breite der TargetID-Beschreibung vor dem Umbruch.",
    ["option.hud.targetid.line_spacing.help"] = "Vertikaler Abstand zwischen TargetID-Beschreibungszeilen.",
    ["option.hud.targetid.visible_delay.help"] = "Wie lange TargetID-Beschriftungen sichtbar bleiben, nachdem der direkte Blick verloren wurde.",
    ["option.hud.targetid.player_offset.help"] = "Vertikaler TargetID-Beschriftungsversatz für Spieler und Spieler-Ragdolls.",
    ["option.hud.targetid.flash_speed.help"] = "Wie schnell blinkende TargetID-Beschriftungen pulsieren.",
    ["option.hud.targetid.show_descriptions.help"] = "Zeigt Standard-Item- und Charakterbeschreibungen unter TargetID-Beschriftungen an.",
    ["option.hud.targetid.show_extras.help"] = "Zeigt zusätzliche TargetID-Beschreibungszeilen von Entitäten an.",
