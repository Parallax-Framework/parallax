...
ax.net:Hook("player.requestString", function(title, subtitle, default, confirmText, cancelText)
    Derma_StringRequest(title, subtitle, default, function(text)
        ax.net:Start("player.requestString", false, text)
    end, function(text)
        ax.net:Start("player.requestString", true, text)
