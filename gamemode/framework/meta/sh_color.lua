...
--- Returns true if the color is perceived as dark by a human viewer. Computes the W3C-standard relative luminance using the formula: `0.299 * R + 0.587 * G + 0.114 * B` (weights reflect human eye sensitivity to each channel). The result is compared against `minimumThreshold`: values below the threshold are considered dark. The default threshold of 186 is a widely-used cutoff for choosing between white and black text on a coloured background.
---@realm shared
