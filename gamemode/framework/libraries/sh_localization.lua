...
---@class ax.localization
--- Localization system for multi-language support. Manages translation strings and provides phrase lookup based on client language settings.
...
--- Gets the current language code for the client. Checks the configuration and console variable to determine the active language.
---@realm shared
