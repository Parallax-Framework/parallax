...
ax.theme.themes.light = {
    glass = {
        panel = Color(240, 242, 245, 180),
        panelBorder = Color(180, 190, 210, 100),
        header = Color(230, 235, 240, 210),
        button = Color(230, 235, 240, 170),
        buttonHover = Color(220, 226, 235, 210),
        buttonActive = Color(200, 210, 225, 230),
        buttonBorder = Color(160, 175, 200, 120),
        input = Color(235, 238, 242, 180),
        inputBorder = Color(180, 190, 210, 120),
        menu = Color(232, 237, 242, 200),
        menuBorder = Color(180, 190, 210, 120),
        overlay = Color(245, 247, 250, 75),
        overlayStrong = Color(240, 242, 245, 125),
        progress = Color(80, 140, 200, 220),
        highlight = Color(100, 160, 220, 140),
        gradientTop = Color(210, 220, 235, 50),
        gradientBottom = Color(240, 245, 250, 70),
        gradientLeft = Color(215, 225, 240, 40),
        gradientRight = Color(215, 225, 240, 40),
        tabBackdrop = Color(245, 247, 250, 45),
        text = Color(30, 35, 45, 255),
        textHover = Color(10, 15, 25, 255),
        textMuted = Color(90, 100, 115, 255)
    }
}
