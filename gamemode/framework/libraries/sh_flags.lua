...
---@class ax.flag
--- Flag management system for character permissions and abilities. Flags are single-letter permissions that can be assigned to characters. Used for controlling access to items, commands, areas, and other features.
