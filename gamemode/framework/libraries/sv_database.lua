...
function ax.database:CreateTables()
    ...
    query = mysql:Create("ax_players")
        ...
        query:Create("last_join", "TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP")
        query:Create("last_leave", "TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP")
