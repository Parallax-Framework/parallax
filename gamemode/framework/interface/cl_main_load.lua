...
function PANEL:Init()
    ...
    self.characters:DockMargin(ax.util:UIScreenScale(128), ax.util:UIScreenScaleH(32), ax.util:UIScreenScale(128), ax.util:UIScreenScaleH(32))
...
function PANEL:PopulateCharacterList()
    ...
    for k, v in pairs(characters) do
        ...
        button:Dock(TOP)
        button:DockMargin(0, 0, 0, ax.util:UIScreenScaleH(4))
        ...
        image:Dock(LEFT)
        image:DockMargin(0, 0, ax.util:UIScreenScale(8), 0)
        ...
        deleteButton:DockMargin(ax.util:UIScreenScale(8), 0, 0, 0)
        ...
        lastPlayed:DockMargin(0, 0, 0, ax.util:UIScreenScaleH(8))
...
function PANEL:PopulateDeletePanel(character)
    ...
    name:Dock(TOP)
    name:DockMargin(ax.util:UIScreenScale(64), 0, 0, ax.util:UIScreenScaleH(16))
    name:SetFont("ax.huge.bold")
