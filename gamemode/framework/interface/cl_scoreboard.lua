...
function PANEL:RebuildScoreboard()
    ...
    for _, tid in ipairs(ids) do
        ...
        for index, client in ipairs(members) do
            ...
            name:SetText(client:SteamName() .. (ax.client:IsAdmin() and (client:Nick() != client:SteamName()) and " (" .. client:Nick() .. ")" or ""))
            ...
            ping:SetText(client:IsBot() and "Bot" or tostring(client:Ping()) .. " ms")
